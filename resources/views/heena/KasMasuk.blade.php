            ...
            <div class="topbar">            
                ...
                <nav class="navbar-custom">    
                    ...
                    <ul class="list-unstyled topbar-nav mb-0">                        
                        ...
                        <li class="creat-btn">
                            <div class="nav-link">
                                <a class=" btn btn-sm btn-danger" href="#" role="button"><i class="fas fa-dollar-sign mr-2"></i>Kas Masuk</a>
                            </div>                                
                        </li>                           
                    </ul>
                </nav>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header bg-primary">
                                                    <h6 class="modal-title m-0 text-white" id="exampleModalPrimary1">Update Kas Masuk</h6>
            ...
            $('form[id=tambah_kas]').submit( (e) => {
                ...
                $.ajax({
                    ...
                    success : (data) => {
                        ...
                        swal({
                            title: "Suksess 😽!",
                            text: "Sukses menambahkan Kas Masuk!",
                            type: "success",
                            icon: "success",
                        }).then(function() {
